...
Future<Directory> getDocumentsDir() async => await pathprovider.getApplicationDocumentsDirectory();

Future<List<Directory>?> getExternalDir() async {
  var externalStorageDirectories = await pathprovider.getExternalStorageDirectories();
